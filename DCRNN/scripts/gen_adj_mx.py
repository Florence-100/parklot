...
def get_adjacency_matrix(distance_df, sensor_ids, normalized_k=0.1):
    ...
    sensor_id_to_ind = {}
    for i, sensor_id in enumerate(sensor_ids): #i is index sensor_id is item
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensor_ids_filename', type=str, default='data/sensor_graph/Nottingham_carparkIds.txt',
                        help='File containing sensor ids separated by comma.')
    parser.add_argument('--distances_filename', type=str, default='data/sensor_graph/Nottingham_carpark_distance.csv',
    ...
    parser.add_argument('--output_pkl_filename', type=str, default='data/sensor_graph/adj_mat_nottingham.pkl',
